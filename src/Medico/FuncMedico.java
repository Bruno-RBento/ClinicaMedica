...
public class FuncMedico {
    ...
    public static ArrayList<Medico> getMedico() {
        ...
        try {
            //TODO
            ObjectInputStream is = new ObjectInputStream(new FileInputStream("./src/MemoryFile/medico.dat"));
    ...
    public static void saveTofile(ArrayList<Medico> medicos) {
        ...
        try {
            //TODO
            ObjectOutputStream os = new ObjectOutputStream(new FileOutputStream("./src/MemoryFile/medico.dat"));
